...
func TestWebSocketServerCreation(t *testing.T) {
	...
	server := NewWebSocketServer(stateMgr, "test_task", nil, "/tmp/test-ws-creation")
...
func TestServerStartAndStop(t *testing.T) {
	...
	server := NewWebSocketServer(stateMgr, "test_task", nil, "/tmp/test-ws")
...
func TestBroadcastChannel(t *testing.T) {
	...
	server := NewWebSocketServer(stateMgr, "test", nil, "/tmp/test-ws")
